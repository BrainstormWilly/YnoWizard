...
public class AsyncUploadImage extends AsyncTask<Bitmap, Integer, String> {
	...
	public SherlockActivity getActivity(){
		return (SherlockActivity) _context;
	}
	...
	protected void onPreExecute()
	{
		...
		_pd.setMessage(getActivity().getString(R.string.uploading_picture));
	...
	protected String doInBackground(Bitmap... $args) {
		try {
			...
			HttpPost httpPost = new HttpPost(getActivity().getString(R.string.url_uploader));
...
//					HttpMultipartMode.BROWSER_COMPATIBLE);
	...
	protected void onPostExecute(String $response) {
		...
		try{
			...
			Toast.makeText(_context.getApplicationContext(), R.string.image_upload_complete, Toast.LENGTH_SHORT);
			$e.printStackTrace();
		}
//		try {
//			
